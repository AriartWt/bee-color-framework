 ...
 * Si _params est une chaine vide, alors c'est _data qui contient la requête/réponse serialisée.
 */
final class KVSDataParserResult {
	/** @var string $_class */
	private $_class;
	/** @var string $_data */
	private $_data;
	...
	/**
	 * KVSDataParserResult constructor.
	 *
