 ...
 */
final class ArchiveHandler extends DefaultContactActionHandler implements IDomainEventListener{
	...
	protected function createCommand(array $data): ICommand {
		return new ArchiveContacts($this->_session->get('user')->getId(),...$data["ids"]);
	}
