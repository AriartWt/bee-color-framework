...
CREATE USER '<?php echo $this->_user; ?>'@'localhost' IDENTIFIED BY '<?php echo $this->_password; ?>';
GRANT SELECT, UPDATE, DELETE, INSERT, EXECUTE ON <?php echo $this->_name; ?>.* TO '<?php echo $this->_user; ?>'@'localhost';
CREATE USER '<?php echo $this->_rootUser; ?>'@'localhost' IDENTIFIED BY '<?php echo $this->_rootPassword; ?>';
